...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  fig.path = "/aryeelab/users/corri/code/cohesin_extrusion_reproducibility/Figures/protocol-",
  out.width = "100%", 
  eval = FALSE
)
```
...
```{r correlation_heatmap, fig.width = 10, fig.height = 8, eval = TRUE}
...
```{r cluster_heatmap,fig.width = 12, fig.height = 7, eval = TRUE}
...
*Clusters look good! We just need to download some more files, then we can move onto visualizing.*
