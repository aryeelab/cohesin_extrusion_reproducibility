...
*Great, this exactly matches our figure in our paper. Now let's make it for each replicate.*
```{r,fig.width=8,fig.height=4}
library(ggrepel)
combined_reps %>% 
  filter(thresh <= 8) %>% 
...
CBS (+) 19bp coordinates: chr18:57976797-57976815
CBS (-) 19bp coordinates: chr18:58481866-58481884
